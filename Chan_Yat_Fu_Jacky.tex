...
\begin{tightitemize}
  ...
  \item Worked on the title of `Implementation of a Singing Voice Synth with MIDI Programming' using PyTorch, FastAPI, and React.
\end{tightitemize}
...
% \bb{\textbf{2-player Game (Java): Game Utilizing Socket and Multi-threading (Individual)}}{\href{https://github.com/chanyatfu/tic-tac-toe}{\underline{GitHub Repo}}}
% \begin{tightitemize}
