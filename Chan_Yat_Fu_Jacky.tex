...
\vspace{-5pt}
\resumeSubHeadingListStart
\resumeProjectHeading{\textbf{MIDI Editor: A versatile and customizable MIDI editor library}}{\href{https://github.com/chanyatfu/react-midi-editor}{\underline{GitHub Repo}}}
\resumeItemListStart
...
\begin{tabular*}{1.0\textwidth}{l @{\hspace{6pt}} l @{\hspace{2pt}} l}
  \textbf{Languages} &  & (proficient): TypeScript, JavaScript, Python, Shell Script, HTML, SCSS, LaTeX \\
  && (familiar): Java, Haskell, PHP, C++ \\
  [2pt]
