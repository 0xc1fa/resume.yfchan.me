...
\resumeItem{Leveraged knowledge in \textbf{Excel}, \textbf{Google Analytics}, \textbf{Google Ads}, and \textbf{MailChimp}.}
\resumeItemListEnd
...
\resumeItem{Utilised: React, Jest, React Testing Library, Next.js, CSS, TypeScript, Rollup.}
\resumeItemListEnd
\vspace{-15pt}
