...
\resumeSubheading{Language Qualifications}{}{}{}\vspace*{-16pt}
\resumeItemListStart
\resumeItem{\textbf{DSE}: \textbf{5* in English Speaking}, 5 in English Writing $|$ \textbf{IELTS} (2019): \textbf{8.5 in Reading}, 7.5 in Listening}
\resumeItemListEnd
...
\resumeItemListStart
\resumeItem{Increased the efficiency of the company's data processing process by implementing a automated data collecting and cleaning pipeline using \textbf{Python} and \textbf{Selenium}.}
...
\resumeItemListStart
\resumeItem{Increased the open and click rates of email campaigns by \textbf{22\% and 17\%} respectively by redesigning the content.}
...
\vspace{-5pt}
\resumeSubHeadingListStart
\resumeProjectHeading{\textbf{MIDI Editor: A versatile and customizable MIDI editor library.}}{\href{https://react-midi-editor-demo.vercel.app}{\underline{Demo}}}
\resumeItemListStart
...
\begin{tabular*}{1.0\textwidth}{l @{\hspace{6pt}} l @{\hspace{2pt}} l}
  \textbf{Languages} &  & (proficient): TypeScript, JavaScript, Python, HTML, SCSS \\
  && (familiar): Java, PHP, Haskell, C++ \\
  [2pt]
